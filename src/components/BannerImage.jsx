    ...
    <div className="pb-6 sm:pb-10">
      <div className="relative h-56 sm:h-80 md:h-96 w-full overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-white p-2 sm:p-4">
          ...
          <h2 className="text-xl sm:text-3xl md:text-5xl hover:text-custom-secondary text-custom-secondary font-extrabold my-3 sm:my-5">{ title }</h2>
          <div className="flex flex-row items-center justify-center gap-1 sm:gap-4">
            ...
            <div className="text-base sm:text-lg text-center hover:text-custom-secondary p-1">{ toText }</div>
          </div>
        </div>
      </div>
    </div>
