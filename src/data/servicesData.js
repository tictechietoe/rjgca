  ...
  return [
    {
      ...
      content: <>
        ...
        <ol className="list-decimal ml-5">
          <li>Company & LLP Incorporation and obtaining requisite government approvals</li>
          <li>Formation of Partnership firm, Conversion of Partnership Firms and Private Ltd Companies into LLP</li>
          <li>Setting up Branch office, Liaison office, Project Office, Joint Venture, Owned Subsidiary etc.</li>
          <li>Assistance in obtaining requisite approvals from regulatory authorities</li>
          <li>Procure other registrations like:
            <ul className="list-disc ml-5">
              <li>PAN</li>
              <li>TAN</li>
              <li>MSME Registration (Udyog Aadhaar)</li>
              <li>Shops & Establishment Registration</li>
              <li>GST Registration</li>
              <li>Import Export Code Registration</li>
              <li>PTEC & PTRC Registration</li>
              <li>Provident Fund & ESIC Registration</li>
              <li>Logo / Trade Mark Registration</li>
              <li>FSAI Registration</li>
    ...
    },
    {
      ...
      content: <>
        ...
        <ol className="list-decimal ml-5">
          ...
          <li>Review and management of Accounting system</li>
          <li>Review and management of Accounts Receivable</li>
          <li>Review and management of Accounts Payable</li>
          <li>Review and management of Banking and finance operation</li>
          <li>MIS reporting</li>
          <li>Virtual CFO services</li>
          <li>Inventory accounting system</li>
          <li>Fixed Asset management</li>
          <li>Liaison With Auditors</li>
          <li>Back office operations including Payroll/ HR management</li>
          <li>Standard Operating Processes</li>
          <li>Budgetory Systems</li>
    ...
    },
    {
      ...
      content: <>
        ...
        <div>Our services include:</div>
        <br />
        <u><h3>Direct Taxation</h3></u>
        <ol className="list-decimal ml-5">
          <li>Preparation and filing of Income Tax returns and other forms</li>
          <li>Periodic review of accounts for payment of Advance Income Tax</li>
          <li>Review and compliance of TDS regulations</li>
          <li>Review and compliance of Transfer Pricing regulations</li>
          <li>Preparing and filing replies to various notices and representing the clients before regulatory authorities</li>
          <li>Preparing and filing appeal and representing the clients before CIT(A)</li>
          <li>Assistance in refund applications</li>
          <li>Tax Planning</li>
          <li>Expatriate and Non Resident Taxation services</li>
          <li>Providing Advices and Opinions on specific issues arising under direct tax laws</li>
          <li>Preparation of Income Tax Compliance Tracker</li>
        </ol>
        <br />
        <u><h3>Indirect Taxation</h3></u>
        <ol className="list-decimal ml-5">
          <li>Computation of GST liability, assistance in making payment and filing of periodic GST returns</li>
          <li>Preparation and filing of Profession tax returns</li>
          <li>Assist in reconciliation of ITC as per books and portal, GSTR-2A reconciliation, GSTR1 vs E-way bill reconciliation, etc</li>
          <li>Preparation of GST compliance tracker</li>
          <li>Assist in queries related to e-Way bills generation</li>
          <li>Review as-is position of the Company as to whether the same is in consonance with the existing GST provisions</li>
          <li>Identify risks and opportunities viz. areas of non-compliance, areas of savings, etc. and advising on the same</li>
          <li>Review of various processes followed from the GST point of view</li>
          <li>Preparation and filing of refund claims including liaising with the authorities and obtaining refund orders</li>
          <li>Preparing and filing replies to various notices and representing the clients before regulatory authorities</li>
          <li>Preparing and filing appeal and representing the clients before appellate authorities</li>
          <li>Drafting and filing applications seeking advance rulings</li>
          <li>Orientation and staff training for GST compliance</li>
          <li>Advising on various GST related queries</li>
          <li>Support in realigning accounting and IT systems to GST framework</li>
        </ol>
      </>,
    ...
    },
    {
      ...
      content: <>
        ...
        <ol className="list-decimal ml-5">
          ...
          <li>E-Filing of Annual Return & Financial Statements with MCA</li>
          <li>E-Filing of various statutory forms, returns and reports with MCA, NCLT, etc</li>
          <li>Assisting in Reporting of Financial Data in XBRL format with MCA</li>
          <li>Certification services of various e-forms</li>
          <li>Obtaining Director Identification Number (DIN) and Digital Signature Certificate (DSC)</li>
          <li>Compliances relating to Managerial Remuneration</li>
          <li>Compliances relating to Change of Name, Change of Objects, change of status from Public Ltd to Private Ltd and vice-versa</li>
          ...
          <li>Ensuring board of director’s compliance as per Companies Act</li>
          <li>Interstate and Intrastate change of Registered office </li>
          ...
          <li>Assisting in winding up/closure of companies in India</li>
          <li>Liaisoning with the office of MCA, NCLT, Register of Firms, Regional Director, Company Law Board and other regulators for obtaining various regulatory approvals</li>
          <li>Facilitating the Buyback, Bonus issue, Rights issue, ESOP, etc</li>
          ...
          <li>Liaising with NSDL, CDSL, Share Transfer Agents for transfer and demat of securities</li>
          <li>Assisting in Secretarial Compliance Audit</li>
          <li>Drafting of MOA, AOA, NDA and other related agreements</li>
          <li>Assistance in registration of charges, search reports and status reports</li>
          <li>Advisory on Corporate Laws & other Allied Laws/Acts</li>
          <li>Advisory services for implementation of Corporate Social Responsibility in compliance with the Companies Act</li>
        </ol>
      </>,
      ...
      content: <>
        ...
        <div>
          ...
          <ul className="list-disc ml-5 font-bold">
            ...
            <li>Financial Health Ananlysis</li>
