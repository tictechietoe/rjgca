  ...
  return [
    {
      ...
      content: <>
        ...
        <div className="flex flex-col gap-2 sm:gap-4 lg:gap-5 p-3 sm:p-4 md:p-6 lg:p-10 mb-5">
        ...
        <div className="flex flex-col gap-2 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4 lg:gap-5 p-3 sm:p-4 md:p-6 lg:p-10 mb-5">
