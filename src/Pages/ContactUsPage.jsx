            ...
            <div className="bg-custom-primary text-white p-6 rounded-lg shadow-lg text-center">
              ...
              <div className="mb-4 border-b border-white/30 pb-4">
                ...
                <div className="text-xs mt-1">
                  Office no.3, Ground floor, Vadhan Niwas, Fanaswadi, Off. Dadisheth Agiary Lane,<br />
                  Near Sitaram Poddar School, Landmark: Shiv sena office,<br />
              ...
              <div>
                ...
                <div className="text-xs mt-1">
                  301, 3rd Floor, Shreeniwas Building, Bandu Gokhale Path,<br />
                  Off. Khadilkar road, Girgaon, Mumbai 400004
                </div>
              </div>
            </div>
