// src/components/DisclaimerPage.js
...
const DisclaimerPage = () => {
  ...
  return (
    <div className="mx-5 md:mx-40 lg:mx-60">
      ...
      <div className="my-5">
        <div>
          Your access to this website constitutes your agreement to be bound by all terms and conditions listed below. If you do not agree to this, you may not access or otherwise use the website.
        </div>
        <br />
        <div>
