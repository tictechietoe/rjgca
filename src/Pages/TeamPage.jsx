    ...
    },
    {
      ...
      expertise: <>
        <ul className="list-disc ml-5 pb-5">
          ...
          <li>Regulatory compliances and Advisory</li>
        </ul>
      </>
    },
    {
